#!/usr/bin/env python
"""Standalone Darcy notch experiment — SVGP + WNO mean + WNO kernel embedding.

    boundCoeff(x,y) -> sol(x,y)

Usage:
    python experiments/darcy_notch/standalone_svgp_wno_darcy_notch.py
"""
...
def main():
    ...
    print("=" * 70)
    print("  Darcy Notch — SVGP + WNO mean + WNO kernel embedding")
