#!/usr/bin/env python
"""Standalone Darcy notch experiment — VNNGP + WNO mean + WNO kernel embedding.

    boundCoeff(x,y) -> sol(x,y)

Usage:
    python experiments/darcy_notch/standalone_vnngp_wno_darcy_notch.py
"""
...
# WNO
WNO_WIDTH = 32
WNO_LEVEL = 3           # level=3 for small 34×34 grid
WNO_LAYERS = 4
WNO_WAVELET = "db4"
EMBED_DIM = 32
...
def main():
    ...
    print("=" * 70)
    print("  Darcy Notch — VNNGP + WNO mean + WNO kernel embedding")
