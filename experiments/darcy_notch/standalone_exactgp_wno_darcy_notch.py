#!/usr/bin/env python
"""Standalone Darcy notch experiment — Exact GP + WNO mean (no kernel embedding).

    boundCoeff(x,y) -> sol(x,y)

Usage:
    python experiments/darcy_notch/standalone_exactgp_wno_darcy_notch.py
"""
...
X_FIELD, Y_FIELD = "boundCoeff", "sol"
NTRAIN, NTEST, SUB = 1500, 100, 3
RESOLUTION = [34, 34]
...
def main():
    ...
    print("=" * 70)
    print("  Darcy Notch — Exact GP + WNO mean")
