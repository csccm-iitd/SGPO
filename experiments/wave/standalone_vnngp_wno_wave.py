#!/usr/bin/env python
"""Standalone Wave experiment — VNNGP + WNO mean + WNO kernel embedding.

    u(x, t=0) -> u(x, t=80)

Usage:
    python experiments/wave/standalone_vnngp_wno_wave.py
"""
...
def main():
    ...
    print("=" * 70)
    print("  Wave — VNNGP + WNO mean + WNO kernel embedding")
