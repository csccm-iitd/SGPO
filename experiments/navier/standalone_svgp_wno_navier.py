#!/usr/bin/env python
"""Standalone Navier-Stokes experiment — SVGP + WNO mean + WNO kernel embedding.

    curl(f) -> omega   (2-D vorticity)

Usage:
    python experiments/navier/standalone_svgp_wno_navier.py
"""
...
def main():
    ...
    print("=" * 70)
    print("  Navier-Stokes — SVGP + WNO mean + WNO kernel embedding")
