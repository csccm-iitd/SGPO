#!/usr/bin/env python
"""Standalone Darcy flow experiment — Exact GP + WNO mean (no kernel embedding).

    a(x,y) -> u(x,y)

Usage:
    python experiments/darcy/standalone_exactgp_wno_darcy.py
"""
...
def main():
    ...
    print("=" * 70)
    print("  Darcy Flow — Exact GP + WNO mean")
