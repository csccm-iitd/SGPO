#!/usr/bin/env python
"""Standalone Darcy flow experiment — VNNGP + WNO mean + WNO kernel embedding.

    a(x,y) -> u(x,y)

Usage:
    python experiments/darcy/standalone_vnngp_wno_darcy.py
"""
...
def main():
    ...
    print("=" * 70)
    print("  Darcy Flow — VNNGP + WNO mean + WNO kernel embedding")
