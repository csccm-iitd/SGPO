#!/usr/bin/env python
"""Standalone Burgers experiment — SVGP (no WNO).

Sparse Variational GP with LMC for:
    a(x) -> u(x, t=1)

Usage:
    python experiments/burger/standalone_svgp_burger.py
"""
...
def main():
    ...
    print("=" * 70)
    print("  Burgers — SVGP (plain, no WNO)")
