#!/usr/bin/env python
"""Standalone Burgers experiment — SVGP + WNO mean + WNO kernel embedding.

    a(x) -> u(x, t=1)

Usage:
    python experiments/burger/standalone_svgp_wno_burger.py
"""
...
def main():
    ...
    print("=" * 70)
    print("  Burgers — SVGP + WNO mean + WNO kernel embedding")
