#!/usr/bin/env python
"""Standalone Burgers experiment — VNNGP + WNO mean + WNO kernel embedding.

Runs VNNGP with:
  - LatentWNOMean: WNO1d features → scalar mean for latent GPs
  - EmbeddingKernel: separate WNO1d for kernel input embedding

    a(x) -> u(x, t=1)

Usage:
    python experiments/burger/standalone_vnngp_wno_burger.py
"""
...
def main():
    ...
    print("=" * 70)
    print("  Burgers — VNNGP + WNO mean + WNO kernel embedding")
