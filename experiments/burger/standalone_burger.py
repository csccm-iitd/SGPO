#!/usr/bin/env python
"""Standalone Burgers equation experiment.

Runs the full VNNGP pipeline for 1-D Burgers equation:
    a(x) -> u(x, t=1)

All hyperparameters are defined as constants at the top of this file.
No YAML config needed -- just run:
    python experiments/burger/standalone_burger.py
"""
...
# Hyperparameters (mirroring configs/burger.yaml)
...
def main():
    ...
    print("=" * 70)
    print("  Standalone Burgers Equation Experiment")
    print(f"  Device     : {device}")
    print(f"  Resolution : {RESOLUTION} (sub={SUB})")
    ...
    # No normalization to decode for Burgers
