...
class WaveConv1d(nn.Module):
    def __init__(self, in_channels, out_channels, level, size, wavelet='db4', mode='symmetric'):
        ...
        # self.conv_approx = nn.Conv1d(in_channels, out_channels, kernel_size=5, padding=2)
        # self.conv_detail = nn.Conv1d(in_channels, out_channels, kernel_size=5, padding=2)
